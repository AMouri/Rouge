    ...
    for i in range(num_items):
        ...
        if not is_blocked(x, y):
            ...
            if dice < 100:
                ...
                item_component = Item(use_function = cast_heal(1))
                item = Object(x, y, '!I', 'healing potion I', libtcod.desaturated_pink, item = item_component)
            elif dice < 150:
                item_component = Item(use_function = cast_heal(2))
                item = Object(x, y, '!II', 'healing potion II', libtcod.pink, item = item_component)
            elif dice < 200:
                item_component = Item(use_function = cast_heal(3))
                item = Object(x, y, '!III', 'healing potion III', libtcod.darker_pink, item = item_component)
            elif dice < 240:
                item_component = Item(use_function = cast_heal(4))
                item = Object(x, y, '~I', 'restoration potion I', libtcod.desaturated_violet, item = item_component)
            elif dice < 255:
                item_component = Item(use_function = cast_heal(5))
                item = Object(x, y, '~II', 'restoration potion II', libtcod.violet, item = item_component)
            elif dice < 260:
                item_component = Item(use_function = cast_heal(6))
                item = Object(x, y, '~III', 'restoration potion III', libtcod.darker_violet, item = item_component)
            elif dice < 360:
                        #create a  lightning bolt scroll
                        item_component = Item(use_function = cast_lightning(1))
                        item = Object(x, y, '#I', 'scroll of lightning bolt I', libtcod.light_yellow, item = item_component)
            elif dice < 410:
                        #create a  lightning bolt scroll
                        item_component = Item(use_function = cast_lightning(2))
                        item = Object(x, y, '#II', 'scroll of lightning bolt II', libtcod.light_yellow, item = item_component)
            elif dice < 450:
                        #create a  lightning bolt scroll
                        item_component = Item(use_function = cast_lightning(3))
                        item = Object(x, y, '#III', 'scroll of lightning bolt III', libtcod.light_yellow, item = item_component)
            elif dice < 480:
                        #create a  lightning bolt scroll
                        item_component = Item(use_function = cast_lightning(4))
                        item = Object(x, y, '#IV', 'scroll of lightning bolt IV', libtcod.light_yellow, item = item_component)
            elif dice < 500:
                        #create a  lightning bolt scroll
                        item_component = Item(use_function = cast_lightning(5))
                        item = Object(x, y, '#V', 'scroll of lightning bolt V', libtcod.light_yellow, item = item_component)
            elif dice < 600:
                        #create a fireball scroll
                        item_component = Item(use_function = cast_fireball(1))
                        item = Object(x, y, '#I', 'scroll of fireball I', libtcod.light_yellow, item = item_component)
            elif dice < 650:
                        #create a fireball scroll
                        item_component = Item(use_function = cast_fireball(2))
                        item = Object(x, y, '#II', 'scroll of fireball II', libtcod.light_yellow, item = item_component)
            elif dice < 690:
                        #create a fireball scroll
                        item_component = Item(use_function = cast_fireball(3))
                        item = Object(x, y, '#III', 'scroll of fireball III', libtcod.light_yellow, item = item_component)
            elif dice < 720:
                        #create a fireball scroll
                        item_component = Item(use_function = cast_fireball(4))
                        item = Object(x, y, '#IV', 'scroll of fireball IV', libtcod.light_yellow, item = item_component)
            elif dice < 740:
                        #create a fireball scroll
                        item_component = Item(use_function = cast_fireball(5))
                        item = Object(x, y, '#V', 'scroll of fireball V', libtcod.light_yellow, item = item_component)
            else:
